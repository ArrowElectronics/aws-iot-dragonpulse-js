...
describe('retrieving a disk observation', function() {
  ...
  it('must throw an exception if a disk entry does not exist', function(done) {
    var testName = this.test.fullTitle();
  ...
  it('must return existing disk observation', function(done) {
    var testName = this.test.fullTitle();
